...
public interface ProductService {
    ...
    @Counted(
            value = "getProductShortnamesCount",
            description = "How many product shortnames calls have been performed.")
    @Timed(value = "getProductShortnamesTimer", description = "How long it takes to get the product shortnames.")
